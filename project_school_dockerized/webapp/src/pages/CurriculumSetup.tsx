      ...
      <div className="ml-6 mr-6 mt-10 border border-gray-400 rounded-md">
        <table className="w-full">
          <tr className=" bg-gray-200 rounded-md text-left">
            ...
            <th className="p-2 font-normal w-[25%] text-gray-600">Grades</th>
          ...
          <tr className="text-left">
            ...
            <td className="p-2 font-semibold text-sm hover:underline cursor-pointer" onClick={()=>{navigate("/curriculum-setup/school/grades")}}>32</td>
