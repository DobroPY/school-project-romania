...
const GradeSubjects = (props)=>{
    ...
    return(
        ...
        <div>
              <p className="font-bold text-xl">First Grade {"> "}<strong className="text-purple-500">Subjects</strong></p>
          </div>
          <AddSubject />
        </div>
        <div className="ml-6 mr-6 mt-10 border border-gray-400 rounded-md">
          <table className="w-full">
            <tr className=" bg-gray-200 rounded-md text-left">
              ...
              <th className="p-2 font-normal w-[35%] text-gray-600">Modules</th>
            ...
            <tr className="text-left">
              ...
              <td className="p-2 font-semibold text-sm hover:underline cursor-pointer" onClick={()=>{navigate("/curriculum-setup/school/grades/firstgrade/subjects/mathematics/modules")}}>12</td>
