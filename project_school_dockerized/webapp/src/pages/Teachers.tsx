      ...
      <div className="ml-6 mr-6 mt-10 border border-gray-400 rounded-md">
        <table className="w-full">
          ...
          <tr className="text-left">
            ...
            <td className="p-2 font-semibold text-sm">Mathematics</td>
            <td className="p-2 font-semibold text-sm">6</td>
            <td className="p-2 font-semibold text-sm">
             <p className="flex items-center">  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <td className="p-2 flex justify-center">
              <button className=" rounded-lg px-4 py-1 h-[100%] bg-blue-200 text-blue-600 flex items-center outline-none">
                <EditTeacherModal text={"Edit"} />
              </button>
              <button className=" rounded-lg px-4 py-1 h-[100%] ml-4 bg-green-200 text-green-700 flex items-center outline-none" onClick={()=>{ navigate("/teachers/13")}}>
                <svg
                  width="20"
                  height="15"
                  className="mr-2"
