...
const SchoolGrades = (props)=>{
    ...
    return(
        ...
        <div className="ml-6 mt-10  flex justify-between">
          <div>
              <p className="font-bold text-xl">Primary School {"> "}<strong className="text-purple-500">Grades</strong></p>
          </div>
          <AddSchoolGrade />
        </div>
        <div className="ml-6 mr-6 mt-10 border border-gray-400 rounded-md">
          <table className="w-full">
            <tr className=" bg-gray-200 rounded-md text-left">
              <th className="py-2 pl-4 pr-2 w-[25%]   font-normal text-gray-600">
                Grade Name
              </th>
              <th className="p-2 font-normal w-[25%] text-gray-600">Subjects</th>
              <th className="p-2 font-normal w-[25%] text-gray-600">Modules</th>
            ...
            <tr className="text-left">
              ...
              <td className="p-2 font-semibold text-sm hover:underline cursor-pointer" onClick={()=>{navigate("/curriculum-setup/school/grades/firstgrade/subjects")}}>12</td>
              <td className="p-2 font-semibold text-sm">32</td>
