  ...
  return (
    <section>
      <div
        className={
          show
            ? "mt-4 border bg-purple-100 text-purple-600 border-purple-600 rounded-lg w-[96%]  p-3"
      ...
      {show ? (
        <div className=" border-l border-r border-b bg-white border-gray-300  rounded-b-lg w-[96%]  p-3">
